...
| B | state | EMA | persistent_state_feedback_dominance | 9.575 | 273.1 | 1 |
| B | state | m | persistent_state_feedback_dominance | 2.424 | 3.728 | 0.9752 |
| B | state | net_buffer | mixed_or_inconclusive | NA | NA | NA |
| B | state | scaler | mixed_or_inconclusive | NA | NA | NA |
| B | state | theta | persistent_state_feedback_dominance | 17.04 | 138.6 | 1 |
| B | state | v | persistent_state_feedback_dominance | 6.34 | 61.37 | 1 |
...
| C | state | EMA | persistent_state_feedback_dominance | 9.5 | 199.3 | 1 |
| C | state | m | persistent_state_feedback_dominance | 2.812 | 3.727 | 0.9648 |
| C | state | net_buffer | mixed_or_inconclusive | NA | NA | NA |
| C | state | scaler | mixed_or_inconclusive | NA | NA | NA |
| C | state | theta | persistent_state_feedback_dominance | 15.97 | 99.85 | 1 |
| C | state | v | persistent_state_feedback_dominance | 4.66 | 20.45 | 0.9991 |
...
| D | state | EMA | persistent_state_feedback_dominance | 11.51 | 359.3 | 1 |
| D | state | m | persistent_state_feedback_dominance | 2.15 | 5.704 | 0.9862 |
| D | state | net_buffer | mixed_or_inconclusive | NA | NA | NA |
| D | state | scaler | mixed_or_inconclusive | NA | NA | NA |
| D | state | theta | persistent_state_feedback_dominance | 25.87 | 260.2 | 1 |
| D | state | v | persistent_state_feedback_dominance | 4.223 | 76.3 | 1 |
