...
if [ "$#" -ne 13 ]; then
  echo "usage: $0 SEED GPU ROOTFS DRIVER_INJECTION SOURCE_ROOT SOURCE_ARCHIVE SOURCE_ARCHIVE_SHA TRAINING_ROOT OUTPUT_ROOT DATASET BASE_PORT PYTHON_DRIVER CACHE_TEMPLATE" >&2
  exit 64
fi
