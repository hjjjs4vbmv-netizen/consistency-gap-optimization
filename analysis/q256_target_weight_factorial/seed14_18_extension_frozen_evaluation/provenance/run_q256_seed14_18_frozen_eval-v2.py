...
def latest_summary(path: Path) -> dict[str, Any]:
    ...
    if attempted != 2000 or not (0 < successful <= attempted) or not math.isclose(processed, 256.0):
...
def main() -> int:
    ...
    try:
        ...
        plan = {
            "schema": "q256-target-weight-seed14-18-frozen-evaluation-plan-v1",
            "status": "RUNNING",
        ...
        for job in jobs:
            ...
            receipt = {
                "schema": "q256-target-weight-seed14-18-evaluation-job-receipt-v1",
        ...
        completion = {
            "schema": "q256-target-weight-seed14-18-evaluation-worker-completion-v1",
        ...
        failure = {
            "schema": "q256-target-weight-seed14-18-evaluation-failure-v1",
