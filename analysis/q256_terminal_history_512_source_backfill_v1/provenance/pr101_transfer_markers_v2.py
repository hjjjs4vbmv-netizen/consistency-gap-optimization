...
def lane(n):
 ...
 for i in range(n,58,32):
  ...
  subprocess.run(['scp','-o','BatchMode=yes','-o','ControlPath='+str(sock),'-P','27815',str(p),'root@px-cloud1.matpool.com:/root/q256-pr101-512-source-fid-backfill-v1/receipts/transfers/'],check=True,stdout=subprocess.DEVNULL)
