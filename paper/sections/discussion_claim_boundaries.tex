...
covering three seeds, five checkpoints, and NFE1/2.  This is a consistent
transient intervention effect over the evaluated early-to-middle horizon.
...
three-seed endpoint means are consequently dominated by one unstable paired
seed rather than describing a common late-training response.

An endpoint mean can therefore mix two estimands: the within-seed schedule
contrast and the between-trajectory incidence of instability.  We retain seed
103 in the frozen analysis, report its two arms separately, and interpret the
IA--IB contrast only at matched seed and budget.  Stable-seed summaries are
descriptive sensitivity analyses, not replacements for the frozen cohort.
