...
estimates the policy-level trajectory contrast induced by that target-endpoint
intervention under the evaluated ImageNet construction.  Because the arms
diverge after training begins, this longitudinal contrast is not an isolated
per-step target-channel effect.  An effect of $g$ independent of $q$ remains
untested.
